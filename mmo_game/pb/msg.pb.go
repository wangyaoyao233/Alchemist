...
type BroadCast struct {
	...
	Pid int32 `protobuf:"varint,1,opt,name=Pid,proto3" json:"Pid,omitempty"`
	Tp  int32 `protobuf:"varint,2,opt,name=Tp,proto3" json:"Tp,omitempty"` //1-世界聊天, 2-玩家位置, 3-动作, 4-移动之后的坐标信息
...
var file_msg_proto_rawDesc = []byte{
	...
	0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x01, 0x50, 0x42, 0x05, 0xaa, 0x02, 0x02, 0x50, 0x62,
